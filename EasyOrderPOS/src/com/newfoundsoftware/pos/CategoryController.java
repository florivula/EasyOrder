...
public class CategoryController implements Initializable {
    ...
    @FXML
    private TableColumn<Category, Integer> colD;
    @FXML
    ...
    public void showCategories(){
        ...
        colD.setCellValueFactory(new PropertyValueFactory<Category, Integer>("id"));
    ...
    private void editEntry(ActionEvent event) {
        ...
        try{
            ...
            String query = "UPDATE categories SET name = '" + tfCategoryName.getText() + " ' WHERE id = '" + category.getId() + "'"; //query per update
            executeQuery(query);
            showCategories();
        }catch(Exception ex){
            System.out.println(ex.getMessage());
    ...
    private void deleteEntry(ActionEvent event) {
        ...
        try{
            Category category = tableCategory.getSelectionModel().getSelectedItem();
            String query = "DELETE FROM categories WHERE id = '" + category.getId() + "'"; //query per delete
            executeQuery(query);
            showCategories();
        }catch(Exception ex){
            System.out.println(ex.getMessage());
